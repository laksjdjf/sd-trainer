...
UNET_TARGET_REPLACE_MODULE_TRANSFORMER = ["Transformer2DModel", "JointTransformerBlock"]
UNET_TARGET_REPLACE_MODULE_ATTENTION = ["Transformer2DModel", "JointTransformerBlock"]
